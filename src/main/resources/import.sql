...
INSERT INTO photos (title, description, url_pic, visible, created_at) VALUES('Trentino', 'Embark on a culinary journey to Trentino with this enticing pizza: Agerola fior di latte, smoky speck, creamy buffalo ricotta, and delicate zucchini blossoms. A delightful blend of flavors inspired by the enchanting region of Trentino!', 'https://res.cloudinary.com/glovoapp/w_600,f_auto,q_auto:low/Products/mqg2xcbdupwnuhiw7a5l', false, '2023-07-06 15:14');
<!-- CATEGORIES
